...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=r"dataset/Ripple.yaml", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "runs/train/16bujia/weights/best.pt", help="model path(s)")
    ...
    parser.add_argument("--name", default="SAC", help="save to project/name")
