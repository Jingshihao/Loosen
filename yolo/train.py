...
def train(hyp, opt, device, callbacks):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            # Backward
            torch.use_deterministic_algorithms(False)  # 新添加的代码
...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="models/yolov5l-FSA.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default="dataset/Ripple.yaml", help="dataset.yaml path")
