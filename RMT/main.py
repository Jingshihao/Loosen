...
from classfication_release.engine import train_one_epoch, evaluate
from classfication_release.losses import DistillationLoss
from classfication_release.samplers import RASampler
...
def get_args_parser():
    ...
    parser.add_argument('--early-conv', action='store_true', default=True)  # 原False
    parser.add_argument('--conv-pos', action='store_true', default=True)  # 原False
    parser.add_argument('--batch-size', default=128, type=int)
    parser.add_argument('--epochs', default=300, type=int)

    # Model parameters
    parser.add_argument('--model', default='RMT_S_LA', type=str, metavar='MODEL',
    ...
    parser.add_argument('--lr-noise-pct', type=float, default=0.5, metavar='PERCENT',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default=r'C:\Users\Administrator\Desktop\LS\data_set', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--output_dir', default=r'C:\Users\Administrator\Desktop\RMT-main\save\LA',
...
def main(args):
    ...
    # model = torch.nn.BatchNorm2d.convert_sync_batchnorm(model)
    model.to(device)
